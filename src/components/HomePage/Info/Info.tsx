          ...
          <div className="my-3">
            <div className="flex gap-3">
              <div className="my-auto bg-slate-100 p-3">
                <Image src={WiFi} alt="WifiIcon" width={25} />
              </div>
              <div>
                <p className="text-lg text-gray-400">WiFi:</p>
                <p className="font-medium">1auta2023</p>
              </div>
            </div>
            <div className="flex gap-3 my-3">
              <div className="my-auto bg-slate-100 p-3">
                <Image src={Clock} alt="ClockIcon" width={25} />
              </div>
              <div>
            ...
            <div className="flex gap-3">
              <div className="my-auto bg-slate-100 p-3 ">
                <Image src={Maps} alt="MapsIcon" width={25} />
              </div>
              <div>
                <p className="text-lg text-gray-400">Адреса</p>
                <p className="font-medium">вулиця Огієнка, 46</p>
              </div>
            </div>
          </div>
