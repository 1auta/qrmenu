...
import { coldDrinksData, ColdDrinks } from "@/common/Cards/DataBar/ColdDrinks";

export const ColdDrinksList: React.FC = () => {
  const [selectedCard, setSelectedCard] = useState<ColdDrinks | null>(null);

  const openModal = (card: ColdDrinks) => {
        ...
        >
          ...
          <div className="flex flex-col justify-between w-full">
            <div className="flex flex-col py-2 text-start md:px-2">
              <p className="font-bolt text-xl leading-5 text-black">
                {card.title}
              </p>
