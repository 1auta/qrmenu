...
import { Macaron, macaronData } from "@/common/Cards/DataDesert/Macaroon";

export const MacaronList: React.FC = () => {
  const [selectedCard, setSelectedCard] = useState<Macaron | null>(null);

  const openModal = (card: Macaron) => {
