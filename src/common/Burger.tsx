...
export const BurgerMenu: React.FC = () => {
  ...
  return (
    <div>
      <div
        id="mySidenav"
        className={`fixed top-0 left-0 h-screen w-0 bg-slate-200 overflow-x-hidden transition-all duration-500 ${
          isOpen ? "w-3/4 lg:w-4/12" : ""
        }`}
      >
        <button
          className="absolute top-0 right-0 p-0 text-white text-6xl cursor-pointer"
          onClick={closeNav}
        >
          &times;
        </button>
